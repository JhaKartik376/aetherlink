...
function MessageInput() {
  ...
  return (
    <div className="border-t border-white/[0.06] bg-[#12121a]/40 p-3 md:p-4">
      ...
      <p className="hidden md:block text-center text-[10px] text-white/10 mt-2.5 font-mono">
